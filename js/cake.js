$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','Let’s make a cake!','Since it’s my birthday, I find it only fitting that you make me a digital birthday cake. Start by making your cake mixture, then bake it in a digital oven and finally decorate. Have fun and Thank you for the Blessings!');
})
